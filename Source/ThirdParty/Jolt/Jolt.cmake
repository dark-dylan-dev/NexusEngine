...
# Root
set(PHYSICS_REPO_ROOT ${CMAKE_SOURCE_DIR}/Source/ThirdParty)
...
if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
	...
	elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "AMD64" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "i386")
		...
		elseif (USE_SSE4_1)
			...
			target_compile_options(Jolt PRIVATE -msse2)
		endif()
		if (USE_LZCNT)
		...
		if (NOT MSVC)
			target_compile_options(Jolt PRIVATE -mfpmath=sse)
		endif()
...
if (NOT ("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows") AND NOT EMSCRIPTEN)
	target_compile_options(Jolt PRIVATE -pthread)
	target_link_options(Jolt PRIVATE -pthread)
endif()
